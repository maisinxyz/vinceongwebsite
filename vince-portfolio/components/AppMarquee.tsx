...
const APPS = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#FFFFFF">
         <path d="M4.12 3.167L.813 5.448l.056 15.342 3.251-2.28.056-15.343zm16.51 1.053l3.37-2.368-15.823.111-3.25 2.281 15.703-.024zm-.056 15.342V4.22l-12.443.056.056 15.342 12.387-.056zM8.344 7.68h3.336v9.333H8.344V7.68zm5.004 0h3.336v9.333h-3.336V7.68z"/>
      </svg>
    ),
  ...
  return (
    <section className="relative w-full overflow-hidden bg-void py-24 sm:py-32 border-t border-silver/10">
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 text-center w-full px-4">
        <p className="font-[family-name:var(--font-space-mono-family)] text-[10px] text-silver/30 tracking-[0.3em] uppercase">
          Connect With Me
        </p>
      </div>
